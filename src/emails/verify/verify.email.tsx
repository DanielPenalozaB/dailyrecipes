...
<body>
    <div align="center" style="padding:32px 8px;background: #f3f4f6;font-family: Helvetica, sans-serif;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 0 30px;line-height: 1.5;">
                        <p style="margin:0;color: #1f2937;font-size: 18px;">
                            Hello ${username},
                            <br />
                            <br />
                    ...
                    <td align="center" style="padding:30px">
                        <span style="display:block;background-color:#f43f5e;border:0px;border-radius:30px;width:auto">
                            <a style="display:block;width:auto;padding:15px 20px 15px 20px;background-color:#f43f5e;font-weight:bold;border-radius:30px;font-size:22px;font-style:normal;line-height:120%;color:#ffffff;text-align:center;text-decoration: none;"
                                target="_blank" href="https://dailyrecipes.danielpenalozab.com/auth/verify/${id}">Verify</a>
                        </span>
                    </td>
                </tr>
                <tr>
        ...
        <table style="border-collapse: collapse;border-spacing: 0px;border: 0px;">
            <tbody>
                <tr>
                    <td style="padding: 30px 30px 0;color: #1f2937;font-size: 13px;">
                ...
                <tr>
                    <td style="padding: 30px 30px 0;color: #1f2937;font-size: 14px;">
