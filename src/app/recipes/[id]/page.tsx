                ...
                <div className="flex w-full max-w-5xl flex-col gap-8">
                    {data ? (
                        ...
                        <>
                            ...
                            <div className="flex min-h-[10vh] min-w-full items-center gap-6">
                            ...
                            <div className="mt-4 h-24 animate-pulse rounded-xl bg-gray-300" />
                            <div className="mt-4 h-7 w-28 animate-pulse rounded-md bg-gray-300" />
                            <div className="mt-4 h-7 animate-pulse rounded-md bg-gray-300" />
